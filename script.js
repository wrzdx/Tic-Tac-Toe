    ...
    board.board.forEach((row, x) => {
      row.forEach((cell, y) => {
        ...
        if (cell.value === playerX.value) {
          cellButton.innerHTML = this.crossSVG;
        } 

        if (cell.value === playerO.value) {
          cellButton.innerHTML = this.circleSVG;
        } 
